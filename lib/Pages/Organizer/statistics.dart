        ...
        child: RefreshIndicator(
          ...
          child: Padding(
              ...
              child: statisticsData.when(
                  data: (statistics) {
                    mostLiked = statistics!.statistics![0].mostLiked.events;
                    mostAttendees =
                          ...
                          mostAttendees!.isEmpty
                              ...
                              : ConstrainedBox(
                                  ...
                                  child: CustomEventCard(
                                      ...
                                      bgColor:
                                          int.parse(mostAttendees![0].bgcolor),
                                      imageUrl: cloudFrontUri! +
                                          mostAttendees![0].images[0],
                                      eventType: mostAttendees![0].eventType,
                          ...
                          mostInteresting!.isEmpty
                              ...
                              : ConstrainedBox(
                                  ...
                                  child: CustomEventCard(
                                      ...
                                      eventType: mostInteresting![0].eventType,
